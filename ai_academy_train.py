...
priors = pickle.load(open('/content/prior_boxes_ssd300.pkl', 'rb'))

bbox_util = BBoxUtility(NUM_CLASSES, priors)

# gt = pickle.load(open('gt_pascal.pkl', 'rb'))

gt = pickle.load(open('/content/dog_cat.pkl', 'rb'))
...
path_prefix = '/content/JPEGImages'
gen = Generator(gt, bbox_util, 4, path_prefix,
                train_keys, val_keys,
                (input_shape[0], input_shape[1]), do_crop=False)

model = SSD300(input_shape, num_classes=NUM_CLASSES)
model.load_weights('/content/weights_SSD300.hdf5', by_name=True)
